...
//GCC
#define EPHOPT_B2b  5                   /* ephemeris option: broadcast + B2b */
...
typedef struct {        /* GPS/QZS/GAL broadcast ephemeris type */
    ...
    //GCC add CNAV data
    int valid, satType; /* SatType:0:reserved,1:GEO,2:IGSO,3:MEO */
    double dotA, deltA, dotn;
    double tow;
    //GCC RINEX4.0 
    int Enmt;            //EPH navigation message type 1£ºLNAV 2:CNAV 3:D1 4:D2 5:CNV1 6:CNV2 7:CNV3 8:SBAS     
    int Inmt;           //STO EOP ION navigation message type 1£ºLNAV 2:CNVX(CNAV CNV123) 3:D1D2  4:SBAS
    double top;        /* top for CNAV RINEX4.0 */
} eph_t;
...
typedef struct {        /* navigation data type */
    ...
    b2bsat_t b2bsat;  /*B2b corrections*/
    b2bsat_t b2bsat_pre;  /*B2b corrections*/
} nav_t;
