...
extern int satsys(int sat, int *prn)
{
    ...
    if (sat<=0||MAXSAT<sat) sat=0;
        ...
        sys=SYS_CMP; sat+=MINPRNCMP-1; // sat - NSATGPS - NSATGLO - NSATGAL - NSATQZS + MINPRNIRN-1 ** 126-21
    }
